...
[![Maturity](https://github.com/giellalt/lang-gle/raw/generated/docs-data/fst-maturity.svg)](https://giellalt.github.io/MaturityClassification.html)
![Lemma count](https://github.com/giellalt/lang-gle/raw/generated/docs-data/fst-lemmacount.svg)
[![Speller suggestion quality](https://github.com/giellalt/lang-gle/raw/generated/docs-data/speller-suggestions.svg)](https://giellalt.github.io/lang-gle/typosreport/)
...
[![Doc build](https://img.shields.io/github/actions/workflow/status/giellalt/lang-gle/docs.yml?logo=github&label=DocCI)](https://github.com/giellalt/lang-gle/actions/workflows/docs.yml)
[![Build Status](https://builds.giellalt.org/api/badge/lang-gle?logo=buildkite&label=CoreCI)](https://builds.giellalt.org/pipelines/lang-gle/builds/latest)

Download nightly / CI/CD installation packages for testing (contains the core zhfst file(s)):

[![Windows](https://img.shields.io/badge/download%40latest-Windows--bhfst-brightgreen)](https://pahkat.uit.no/main/download/speller-gle?platform=windows&channel=nightly)
[![MacOS](https://img.shields.io/badge/download%40latest-macOS--bhfst-brightgreen)](https://pahkat.uit.no/main/download/speller-gle?platform=macos&channel=nightly)
[![Mobile](https://img.shields.io/badge/download%40latest-mobile--bhfst-brightgreen)](https://pahkat.uit.no/main/download/speller-gle?platform=mobile&channel=nightly)
...
- [Language specific documentation](https://giellalt.github.io/lang-gle/)
- [General documentation](https://giellalt.github.io/)

Core dependencies
-----------------

In order to compile and use Irish language morphology and
...
Using Git:
```
git clone https://github.com/giellalt/lang-gle
```

Using Subversion:
```
svn checkout https://github.com/giellalt/lang-gle.git/trunk lang-gle
```
