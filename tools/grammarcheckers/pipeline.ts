...
export default function gleGramRelease(entry: StringEntry): Command {
    ...
    x = cg3.mwesplit(x);
    x = divvun.cgspell(x, { acc_model_path: "acceptor.default.hfst", err_model_path: "errmodel.default.hfst" });
