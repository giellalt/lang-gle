...
This directory contains source files for the Irish language morphology
...
-   <https://giellalt.uit.no/lang/fle/IrishDocumentation.html>
    (analyser)
...
In order to compile and use Irish language morphology and dictionaries,
you need:
...
The Irish language sources can be acquired using [giella SVN
